...
function getUrlParam(name = '') {
  const search = window.location.href.split('?')[1].replace(/\+/g, ' ')
  if (!search) {
    return {}
  }
  const obj = {}
...
module.exports = { isEmpty, copyToClipboard, deepClone, objReset, msg, onlyNum, onlyPlusNum, numFormat, isProduction, getUrlParam,PasswordChecking }